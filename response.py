...
if __name__ == '__main__':
	...
	utterance = "Porsche 911"
	# print(json.dumps(get_response_wolframaplha(utterance), indent=4, sort_keys=True))

	wolframResponse = wolframalphaClient.query(utterance)
	print(wolframResponse)
